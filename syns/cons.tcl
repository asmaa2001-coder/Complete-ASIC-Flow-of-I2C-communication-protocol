...
set_input_delay -max 0.5 -clock [get_clocks wb_clk_i] [remove_from_collection [all_inputs] [get_ports wb_clk_i]]
set_output_delay -max 0.5 -clock [get_clocks wb_clk_i] [all_outputs]
